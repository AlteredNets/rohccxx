...
TEST_CASE("ROHCv2 compressed profile refresh CRC failures are rejected")
{
    SECTION("RTP/UDP/IP")
    {
...
TEST_CASE("UDP/IP RFC 5225 profile emits IR refresh after IR and round-trips")
{
    rohc_comp* comp = rohc_comp_new2(4, ROHCCXX_DIRECTION_UPLINK);
    rohc_decomp* decomp = rohc_decomp_new2(4, ROHCCXX_DIRECTION_UPLINK);
    REQUIRE(comp != nullptr);
...
TEST_CASE("ESP/IP RFC 5225 profile emits IR refresh after IR and round-trips")
{
    rohc_comp* comp = rohc_comp_new2(4, ROHCCXX_DIRECTION_UPLINK);
    rohc_decomp* decomp = rohc_decomp_new2(4, ROHCCXX_DIRECTION_UPLINK);
    REQUIRE(comp != nullptr);
...
TEST_CASE("ESP/IP RFC 5225 profile uses IR refresh when sequence is not carried by FO")
{
    rohc_comp* comp = rohc_comp_new2(4, ROHCCXX_DIRECTION_UPLINK);
    rohc_decomp* decomp = rohc_decomp_new2(4, ROHCCXX_DIRECTION_UPLINK);
    REQUIRE(comp != nullptr);
...
TEST_CASE("IP-only RFC 5225 profile emits IR refresh after IR and round-trips")
{
    rohc_comp* comp = rohc_comp_new2(4, ROHCCXX_DIRECTION_UPLINK);
    rohc_decomp* decomp = rohc_decomp_new2(4, ROHCCXX_DIRECTION_UPLINK);
    REQUIRE(comp != nullptr);
...
static constexpr Ipv6TraceFixture ipv6_trace_fixtures[] = {
    ...
    {ParityProfile::Udp, "IPv6 UDP/IP", {80, 80, 38}, {0x28DAE527U, 0x19886A2BU, 0x62211071U}},
    {ParityProfile::Esp, "IPv6 ESP/IP", {80, 80, 80}, {0x1130FE35U, 0x1130FE35U, 0x1130FE35U}},
    {ParityProfile::Ip, "IPv6 IP-only", {82, 82, 44}, {0x3F7AD763U, 0x56983E50U, 0x73A85E58U}},
    {ParityProfile::RtpUdpLite, "IPv6 RTP/UDP-Lite/IP", {86, 43, 26}, {0xBC53256AU, 0x378AA1A6U, 0x56327A09U}},
    {ParityProfile::UdpLite, "IPv6 UDP-Lite/IP", {85, 46, 40}, {0x45CA8475U, 0xD5B9DECAU, 0xA92A5D67U}},
};
...
static constexpr std::uint8_t rtp_trace_0[] = {0xFD,0x01,0x8B,0x40,0x11,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x12,0x34,0x56,0x78,0xCA,0xFE,0xBA,0xBE,0x00,0x00,0x40,0x00,0x00,0x00,0x00,0x00,0x00,0x03,0xE8,0x00,0x00,0x04,0xD2,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00};
static constexpr std::uint8_t rtp_trace_1[] = {0xFD,0x01,0xF3,0x40,0x11,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x12,0x34,0x56,0x78,0xCA,0xFE,0xBA,0xBE,0x00,0x00,0x40,0x00,0x00,0x00,0x00,0x00,0x00,0x03,0xE9,0x00,0x00,0x04,0xD3,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00};
static constexpr std::uint8_t rtp_trace_2[] = {
    0x00, 0x6A, 0xB5, 0x00, 0xE2, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00
};
static constexpr std::uint8_t udp_trace_0[] = {0xFD,0x02,0x6A,0x40,0x11,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x12,0x34,0x56,0x78,0x00,0x00,0x40,0x00,0x00,0x00,0x00,0x00,0x01,0x00,0x00,0x00,0x03,0xE8,0x00,0x00,0x04,0xD2,0xCA,0xFE,0xBA,0xBE,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00};
static constexpr std::uint8_t udp_trace_1[] = {0xFD,0x02,0xDD,0x40,0x11,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x12,0x34,0x56,0x78,0x00,0x00,0x40,0x00,0x00,0x00,0x00,0x00,0x02,0x00,0x00,0x00,0x03,0xE9,0x00,0x00,0x04,0xD3,0xCA,0xFE,0xBA,0xBE,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00};
static constexpr std::uint8_t udp_trace_2[] = {
    0x7A, 0xFC, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0xEA, 0x00, 0x00,
    0x04, 0xD4, 0xCA, 0xFE, 0xBA, 0xBE, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00
};
static constexpr std::uint8_t esp_trace_0[] = {0xFD,0x03,0x90,0x40,0x32,0xCB,0x00,0x71,0x01,0xCB,0x00,0x71,0x02,0xDE,0xAD,0xBE,0xEF,0x00,0x00,0x40,0x00,0x00,0x00,0x00,0x00,0xE8,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00};
static constexpr std::uint8_t esp_trace_1[] = {0xFD,0x03,0xFD,0x40,0x32,0xCB,0x00,0x71,0x01,0xCB,0x00,0x71,0x02,0xDE,0xAD,0xBE,0xEF,0x00,0x00,0x40,0x00,0x00,0x00,0x00,0x00,0xE9,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00};
static constexpr std::uint8_t esp_trace_2[] = {0xFD,0x03,0x4A,0x40,0x32,0xCB,0x00,0x71,0x01,0xCB,0x00,0x71,0x02,0xDE,0xAD,0xBE,0xEF,0x00,0x00,0x40,0x00,0x00,0x00,0x00,0x00,0xEA,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00};
static constexpr std::uint8_t ip_trace_0[] = {0xFD,0x04,0x6D,0x40,0x06,0xC0,0x00,0x02,0x01,0xC6,0x33,0x64,0x02,0x00,0x00,0x40,0x00,0x00,0x00,0x01,0xE8,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00};
static constexpr std::uint8_t ip_trace_1[] = {0xFD,0x04,0x1F,0x40,0x06,0xC0,0x00,0x02,0x01,0xC6,0x33,0x64,0x02,0x00,0x00,0x40,0x00,0x00,0x00,0x02,0xE9,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00};
static constexpr std::uint8_t ip_trace_2[] = {
    0x79, 0x52, 0x00, 0x00, 0xEA, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
};
...
static constexpr std::uint8_t udp_lite_trace_2[] = {
    0x77, 0x51, 0x00, 0x00, 0x00, 0x10, 0x9A, 0xBC, 0x44, 0xEA, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,

...
- Optional third-party oracle hooks are documented in [`docs/external_oracle.md`](docs/external_oracle.md). The in-repo generated corpora and tests are the primary release gates.
